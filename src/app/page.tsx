          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button variant="outline" size="lg" className="group relative border-white text-white hover:bg-white hover:text-red-600 transition-colors overflow-hidden">
                  <span className="inline-flex items-center group-hover:opacity-0 transition-opacity">
